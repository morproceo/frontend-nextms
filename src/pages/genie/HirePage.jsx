...
export default function HirePage() {
  ...
  const bundleActive = mode === 'bundle';
            ...
            >
              ...
              <div className="mt-5 pt-4 border-t border-surface-tertiary">
                {includedInBundle ? (
                  ...
                  <button
                    type="button"
                    className="w-full py-2.5 rounded-button bg-surface-secondary text-text-secondary text-body-sm font-medium border border-surface-tertiary hover:bg-surface-tertiary transition-colors"
                  >
                    Cancel hire
                  </button>
                ) : (
