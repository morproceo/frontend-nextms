 ...
 * arrows on the ends. Scrolls to top of the table on change so the user sees
...
function Pager({ page, totalPages, loading, onChange }) {
  ...
  // Build the visible page list: always 1 and totalPages, then a window
  // around the current page. Insert null sentinels for ellipses.
  const items = [];
